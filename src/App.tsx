    ...
    try {
      ...
      if (data.decision !== 'NO_TRADE') {
        ...
        sendTelegramSignal({
          ...
          entryPrice: data.trade_setup?.entry_price,
          stopLoss: data.trade_setup?.stop_loss,
          breakevenTriggerPrice: data.trade_setup?.beTriggerPrice,
          target50PercentPrice: data.trade_setup?.target50PercentPrice,
          lockProfitPrice: data.trade_setup?.quadScaleOut?.tp1_0_5r || data.trade_setup?.beTriggerPrice,
    ...
    setResult((prevResult) => {
      ...
      if (prevResult.decision !== updated.decision && updated.decision !== 'NO_TRADE') {
        ...
        sendTelegramSignal({
          ...
          entryPrice: updated.trade_setup?.entry_price,
          stopLoss: updated.trade_setup?.stop_loss,
          breakevenTriggerPrice: updated.trade_setup?.beTriggerPrice,
          target50PercentPrice: updated.trade_setup?.target50PercentPrice,
          lockProfitPrice: updated.trade_setup?.quadScaleOut?.tp1_0_5r || updated.trade_setup?.beTriggerPrice,
